...
public class PermissionHelper {
    ...
    public static PermissionHelper getInstant() {
    ...
    public static class FirPermissionActivity extends Activity {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (isGranted(this, permissionHelper.permissions)) {
                if (permissionHelper.onPermissionCallback != null) {
                    permissionHelper.onPermissionCallback.onGranted();
                }
            } else {
                String[] permissions = permissionHelper.permissions.toArray(new String[permissionHelper.permissions.size()]);
        ...
        public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
            if (requestCode == REQUEST_CODE && isGranted(this, permissionHelper.permissions)) {
                if (permissionHelper.onPermissionCallback != null) {
                    permissionHelper.onPermissionCallback.onGranted();
                }
            } else {
                if (permissionHelper.onPermissionCallback != null) {
                    permissionHelper.onPermissionCallback.onDenied();
                }
            }
            finish();
        }
